...
import com.example.demo.exception.ReservationCollisionException;
...
import com.example.demo.repository.StayAvailabilityRepository;
...
public class ReservationService {
    ...
    public List<Reservation> listByGuest(String username) {
        return reservationRepository.findByGuest(new Customer.Builder().setUsername(username).build());
    }
    ...
    public void add(Reservation reservation) throws ReservationCollisionException {
        ...
        System.out.println("shengyang : "+duration);
